    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            {/* Cancel Game Button - Only for admins with active game */}
            {hasAdminPrivileges && hasActiveGame && onCancelGame && (
              <button
                onClick={() => {
                  if (window.confirm('¿Cancelar campeonato actual? Se perderán todos los datos.')) {
                    onCancelGame();
                  }
                }}
